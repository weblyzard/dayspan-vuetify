      ...
      <div class="ds-week-view-scrollable" ref="scrollArea">
        ...
        <div class="ds-week-view-pane" ref="pane" :style="dayHeight">
          ...
          <div class="ds-week">
            ...
            <template v-for="day in calendar.days" :key="day.dayIdentifier">
...
const componentName = "dsDaysView";
  ...
  props:
  {
    ...
    scrollToFirst:
    {
      ...
      default() {
        ...
        return $dayspan.defaults[componentName].scrollToFirst;
      }
    },
    ...
    scrollBuffer:
    {
      ...
      default() {
        const $dayspan = inject("$dayspan", {});
        return $dayspan.defaults[componentName].scrollBuffer;
      }
    },
    ...
    hours:
    {
      ...
      default() {
        const $dayspan = inject("$dayspan", {});
        return $dayspan.defaults[componentName].hours;
      }
    }
  },
