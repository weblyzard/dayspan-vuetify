<template>
  ...
  <div class="ds-day"
    ...
    <template v-for="(event, i) in day.events" :key="i">
...
<script>
import { Constants, CalendarDay, CalendarEvent, Calendar, Functions as fn } from 'dayspan';
import DsCalendarEventTime from "./CalendarEventTime";
import DsCalendarEventTimePlaceholder from "./CalendarEventTimePlaceholder";
